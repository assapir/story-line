...
export class AddById1560428472810 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP TABLE "temporary_line"`);
        await queryRunner.query(`ALTER TABLE "line" RENAME TO "temporary_line"`);
        await queryRunner.query(`CREATE TABLE "line" ("id" varchar PRIMARY KEY NOT NULL, "text" varchar NOT NULL, "userId" varchar NOT NULL, "storyId" varchar NOT NULL, CONSTRAINT "FK_992ad5bdd435b87037a6b7ab0d6" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "line"("id", "text", "userId", "storyId") SELECT "id", "text", "userId", "storyId" FROM "temporary_line"`);
        await queryRunner.query(`DROP TABLE "temporary_line"`);
    }
